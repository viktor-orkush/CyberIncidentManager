...
public class AlgScanTable {

    private static final String TABLE_ALG_SCAN = "alg_scan";
    ...
    public static ArrayList<AlgorAction> getAllColumn (){
        ...
        try {
            ...
            ResultSet resultSet = stat.executeQuery("select id, action, time from " + TABLE_ALG_SCAN);
